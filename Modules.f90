...
! Here we evaluate the effectos of the trap at SITE
! parametrized by a shift in the tunneling rate DELTA_J
! , modifed renormalizaton J_REN, K_J
! and local energy shift EPSILON_J
