...
ManybodyHubbard: subset.f90 HilbertDimension.f90 main_MBH_Fermions.f90
	...
	$(GF) -o ManybodyHubbard_Bosons   tight_binding_boson_Hamiltonian.o Runge-Kutta4thorder_SIMPLE.o fftw_1D.o bvec.o subset.o HilbertDimension.o HubbardHamiltonian.o main_MBH_Bosons.f90 -I/usr/include -I$(MMFINC) -L$(MMFLIB) -lopenmmf  $(GFFLAGS) -L$(MKLLIBS) -I$(MKLINC) $(MKLFLAGS)
